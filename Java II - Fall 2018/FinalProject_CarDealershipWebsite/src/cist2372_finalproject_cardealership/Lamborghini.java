...
public class Lamborghini extends Car
{
    ...
    // CONSTRUCTORS
    public Lamborghini(String color, String convertible, ImageView picture)
    {
    ...
    /**
     * @override
     * all car performance set to $400,000.00
     */
